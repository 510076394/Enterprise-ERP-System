...
import { NavBar, Form, Field, CellGroup, Button, Popup, DatePicker, Picker, showToast } from 'vant';
...
const warehouseText = computed(() => {
  const warehouse = warehouseOptions.value.find(item => item.id === checkForm.value.warehouse_id);
