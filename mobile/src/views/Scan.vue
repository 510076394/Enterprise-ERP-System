...
/**
 * Scan.vue
 * @description 移动端扫码功能页面 - Glassmorphism 风格
 * @date 2025-12-29
 * @version 2.0.0
 */
-->
  ...
  <div class="scan-page">
    ...
    <div class="page-content">
      ...
      <div class="type-selector-section">
        <div class="type-tabs">
          <div v-for="type in scanTypes" :key="type.value"
            :class="['type-tab', { active: selectedType === type.value }]" @click="selectType(type.value)">
      ...
      <div class="scan-area-section">
        ...
        <div v-if="scanResult && resultData" class="scan-result">
          ...
          <div class="result-actions">
            <van-button type="primary" block @click="handleViewDetail">
              查看详情
            </van-button>
      ...
      <div class="quick-actions-section">
        ...
        <div class="actions-grid">
          <div v-for="action in quickActions" :key="action.value" class="action-card"
    ...
    <van-popup v-model:show="showManualInput" position="bottom" round>
      <div class="manual-input-popup">
        ...
        <div class="popup-content">
          <van-field v-model="manualCode" type="textarea" placeholder="请输入编码或扫描内容"
            :autosize="{ minHeight: 80, maxHeight: 120 }" :border="false" />
        </div>
        <div class="popup-actions">
          <van-button type="primary" block @click="confirmManualInput">
            确认
          </van-button>
        </div>
      </div>
