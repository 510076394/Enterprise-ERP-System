        ...
        <div class="form-section" v-if="materialRequirements.length > 0 || selectedProduct">
          ...
          <div class="materials-preview">
            <div v-if="materialRequirements.length > 0">
              <div v-for="material in materialRequirements" :key="material.id" class="material-item">
...
import {
  NavBar, Button, Form, Field, Popup, Search, Empty,
  showToast, showLoadingToast, closeToast
} from 'vant';
...
// 监听数量变化，自动计算物料需求
watch(() => planForm.quantity, (newQuantity) => {
